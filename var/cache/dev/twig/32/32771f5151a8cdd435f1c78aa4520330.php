...
class __TwigTemplate_cc0551a42460424f37b7a1f81aa2b2a3 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    <article>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            // line 15
            echo "            <h1><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_post_show", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 15)]), "html", null, true);
            echo "\">";
            ...
            <p>
                ";
            // line 18
            echo twig_nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "content", [], "any", false, false, false, 18), "html", null, true));
            echo "
            </p>
        ";
        }
...
";
    ...
    {
        return array (  120 => 21,  111 => 18,  102 => 15,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "post/index.html.twig", "/home/lucky/Desktop/recruitment_backend_task2/templates/post/index.html.twig");
    }
}
