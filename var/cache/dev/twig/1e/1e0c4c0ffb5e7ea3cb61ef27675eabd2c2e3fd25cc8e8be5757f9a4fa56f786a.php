...
class __TwigTemplate_77631db892ea7abddea0d5c0810dd60b3e0e430f3a4b76537089a3a62e501c5e extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                ...
                echo "
                    ";
                // line 193
                if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "parameters", [], "any", false, false, false, 193)), 0))) {
                    // line 194
